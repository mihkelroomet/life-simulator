...
var MOTIVATION_LOSS : float = 100 # This will be replaced by calculations based on needs
...
var RELATEDNESS_LOSS : float = 100 # Per hour of game time
var NUTRITION_LOSS : float = 50
var PA_LOSS : float = 25
var SLEEP_LOSS : float = 10
